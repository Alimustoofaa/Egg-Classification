...
def main_process(image=None):
    image = cv2.imread('/Users/alimustofa/Downloads/telur 3/images (3).jpg')
    h, w  = image.shape[:2]
    # change image to rgb
    ...
    image_thres_tozero = image_thresold_tozero(image_clahed, CLASS_THRES)
    # image morphology
    ...
    classification = 'Fertil' if CLASS_MIN_AREA >= 15 else 'Infertil'
